...
import { C as Content } from '../../../chunks/introduction_BmGhGKOi.mjs';
...
}, "/home/ec2-user/vit/AdminLTE/src/pages/pages/docs/introduction.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/pages/pages/docs/introduction.astro";
const $$url = "/pages/docs/introduction";
