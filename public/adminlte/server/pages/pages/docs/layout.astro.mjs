...
}, "/home/ec2-user/vit/AdminLTE/src/pages/pages/docs/layout.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/pages/pages/docs/layout.astro";
const $$url = "/pages/docs/layout";
