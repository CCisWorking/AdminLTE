...
}, "/home/ec2-user/vit/AdminLTE/src/pages/pages/layout/fixed-sidebar.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/pages/pages/layout/fixed-sidebar.astro";
const $$url = "/pages/layout/fixed-sidebar";
