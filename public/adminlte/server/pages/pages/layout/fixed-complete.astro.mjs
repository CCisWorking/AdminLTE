...
}, "/home/ec2-user/vit/AdminLTE/src/pages/pages/layout/fixed-complete.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/pages/pages/layout/fixed-complete.astro";
const $$url = "/pages/layout/fixed-complete";
