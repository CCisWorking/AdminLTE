...
}, "/home/ec2-user/vit/AdminLTE/src/pages/pages/layout/fixed-header.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/pages/pages/layout/fixed-header.astro";
const $$url = "/pages/layout/fixed-header";
