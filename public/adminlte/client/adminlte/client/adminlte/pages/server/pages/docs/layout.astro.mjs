...
starter page
                ...
                start from scratch.
</p> </div> <p>The layout consists of five major parts:</p> <ul> <li>
...
</li> </ul> </div> <!-- /.container-fluid --> </div> <!--end::App Content--> </main> <!--end::App Main--> ${renderComponent($$result, "Footer", $$Footer, {})} </div> <!--end::App Wrapper--> <!--begin::Script--> ${renderComponent($$result, "Scripts", $$Scripts, { "path": path })} <!--end::Script--> </body><!--end::Body--></html>`;
}, "/home/ec2-user/vit/AdminLTE/src/html/pages/docs/layout.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/html/pages/docs/layout.astro";
const $$url = "/docs/layout.html";
