...
import { C as Content } from '../../../../chunks/main-header_Ie7W8d2U.mjs';
...
}, "/home/ec2-user/vit/AdminLTE/src/pages/pages/docs/components/main-header.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/pages/pages/docs/components/main-header.astro";
const $$url = "/pages/docs/components/main-header";
