...
const $$FixedHeader = createComponent(($$result, $$props, $$slots) => {
  const title = "AdminLTE 4 | Fixed Header";
  const path = "../../../dist";
  const mainPage = "layout";
  const page = "fixed-header";
  return renderTemplate`<html lang="en"> <!--begin::Head--> <head>${renderComponent($$result, "Head", $$Head, { "title": title, "path": path })}${renderHead()}</head> <!--end::Head--> <!--begin::Body--> <body class="fixed-header sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper--> <div class="app-wrapper"> ${renderComponent($$result, "Topbar", $$Topbar, { "path": path })} ${renderComponent($$result, "Sidenav", $$Sidenav, { "path": path, "mainPage": mainPage, "page": page })} <!--begin::App Main--> <main class="app-main"> <!--begin::App Content Header--> <div class="app-content-header"> <!--begin::Container--> <div class="container-fluid"> <!--begin::Row--> <div class="row"> <div class="col-sm-6"> <h3 class="mb-0">Fixed Header</h3> </div> <div class="col-sm-6"> <ol class="breadcrumb float-sm-end"> <li class="breadcrumb-item"><a href="#">Home</a></li> <li class="breadcrumb-item active" aria-current="page">
Fixed Header
...
}, "/home/ec2-user/vit/AdminLTE/src/html/pages/layout/fixed-header.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/html/pages/layout/fixed-header.astro";
const $$url = "/layout/fixed-header.html";
