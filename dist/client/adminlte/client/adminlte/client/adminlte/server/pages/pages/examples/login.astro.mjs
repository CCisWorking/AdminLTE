...
}, "/home/ec2-user/vit/AdminLTE/src/pages/pages/examples/login.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/pages/pages/examples/login.astro";
const $$url = "/pages/examples/login";
