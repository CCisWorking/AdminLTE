...
}, "/home/ec2-user/vit/AdminLTE/src/pages/pages/layout/fixed-footer.astro", undefined);

const $$file = "/home/ec2-user/vit/AdminLTE/src/pages/pages/layout/fixed-footer.astro";
const $$url = "/pages/layout/fixed-footer";
