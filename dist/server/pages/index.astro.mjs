...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  const mainPage = "";
  const page = "index";
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": title, "mainPage": mainPage, "page": page }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container-fluid py-4"> <h1>Welcome to the Vitness</h1> </div> ` })}`;
