...
import { $ as $$Sidenav } from './_sidenav_GULq_0sp.mjs';
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head>', "", '</head> <body class="sidebar-mini layout-fixed sidebar-expand-lg bg-body-tertiary"> <div class="app-wrapper"> ', " ", ' <main class="app-main"> ', " </main> ", " </div> ", ' <script type="module">\n      import mermaid from "https://cdn.jsdelivr.net/npm/mermaid@10.4.0/dist/mermaid.esm.min.mjs";\n      mermaid.initialize({ startOnLoad: true });\n    <\/script> </body> </html>'])), renderComponent($$result, "Head", $$Head, { "title": title, "path": path }), renderHead(), renderComponent($$result, "Topbar", $$Topbar, { "path": path }), renderComponent($$result, "Sidebar", $$Sidenav, { "path": path, "mainPage": mainPage, "page": page }), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, {}), renderComponent($$result, "Scripts", $$Scripts, { "path": path }));
